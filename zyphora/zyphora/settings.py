"""
Django settings for lumora project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'projects.context_processors.task_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'zyphora.wsgi.application'
...
GROQ_API_KEY = "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"